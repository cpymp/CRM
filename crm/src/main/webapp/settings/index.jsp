...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">系统设置</span></div>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div style="position: relative; width: 55%; height: 70%; left: 22%;">
			...
			<div style="position: relative; width: 33%; height: 50%;">
				...
				<br>
				<a   onclick="window.location.href='settings/qx/index.do?id=${sessionScope.user.id}'">权限管理</a>
			</div>
